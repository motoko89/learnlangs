#!/usr/bin/env python3
"""Spanish Apple Podcast → Vocab Listening-Practice Generator.
...
src/common/applepodcast.py; the Spanish-specific pieces (language codes, the
OpenAI vocab params, and the voices) live in src/spanish/common/langconfig.py,
